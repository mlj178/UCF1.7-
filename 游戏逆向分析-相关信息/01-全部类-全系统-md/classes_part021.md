...
- `Encoding encoding`（编码 encoding）(偏移: 0x0)
...
- `float x`（浮点数 x）(偏移: 0x8)
- `float y`（浮点数 y）(偏移: 0xC)
...
- `uint x`（无符号整数 x）(偏移: 0x0)
- `uint y`（无符号整数 y）(偏移: 0x4)
...
- `uint x`（无符号整数 x）(偏移: 0x8)
- `uint y`（无符号整数 y）(偏移: 0xC)
