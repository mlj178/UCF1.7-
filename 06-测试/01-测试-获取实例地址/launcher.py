...
class LauncherUI:
    def __init__(self, root):
        self.root = root
        self.root.title("获取玩家对象地址 - Launcher")
    ...
    def setup_ui(self):
        ...
        title_label = ttk.Label(main_frame, text="🎮 获取玩家对象地址工具", font=("Arial", 14, "bold"))
                ...
                if msg['type'] == 'send':
                    ...
                    if isinstance(payload, dict):
                        ...
                        if t == 'log':
                            ...
                            self.log(f"{icon} [{module}] {message}")
                        else:
