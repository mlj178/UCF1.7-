...
class InstanceGetterUI(ctk.CTk):
    def __init__(self):
        super().__init__()
        
        self.title("UnityCrossFire 实例地址获取工具")
    ...
    def setup_ui(self):
        ...
        self.script_entry = ctk.CTkEntry(control_frame, width=500)
        self.script_entry.grid(row=2, column=1, columnspan=2, padx=5, pady=5, sticky="ew")
