#=============================================================================
# esp_test.py - ESP Step 1 (fixed)
# 注入 m.dll，查看日志文件 esp_log.txt
# 运行: python esp_test.py
#=============================================================================
...
def main():
    ...
    print(f"    Expected in-game: green wireframe rectangle")
    print(f"    Run in another terminal: Get-Content '{LOG_PATH}' -Wait")
    print(f"    (Or use: type {LOG_PATH}  to check once)")
