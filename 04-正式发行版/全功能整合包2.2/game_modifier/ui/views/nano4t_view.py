...
class Nano4tView:
    ...
    def build(self, scroll):
        nano4t_top_frame = ctk.CTkFrame(scroll, corner_radius=8, fg_color="#2b2b2b")
        nano4t_top_frame.pack(fill="x", padx=8, pady=(8, 4))
        ...
        nano4t_next_label = ctk.CTkLabel(scroll, text="", font=("Microsoft YaHei", 11), text_color="#aaccaa")
        ...
        btn_frame = ctk.CTkFrame(scroll, corner_radius=8)
        btn_frame.pack(fill="x", padx=8, pady=(2, 4))
