...
def build_card(parent, manifest, row, col, colspan, callbacks, card_builder):
    ...
    button = ctk.CTkButton(btn_frame, text="\u25b6 \u7b2c\u4e00\u6b21\u8df3\u8fc7\u9700\u8981\u70b9\u51fb\u4e24\u6b21", font=("Microsoft YaHei", 14, "bold"), height=45, command=callbacks["skip_round"], fg_color="#b45309", hover_color="#92400e")
