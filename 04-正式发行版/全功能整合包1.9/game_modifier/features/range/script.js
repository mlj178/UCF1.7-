...
var __pluginFeatureId = "range";
var __pluginModuleName = "range";
var __pluginEnabled = false;
var __pluginConfig = {"range": 50.0};
...
function __pluginApplyConfig(config) {
  ...
  var range = __pluginConfig.range;
  if (typeof range !== 'number') range = __pluginConfig.value;
  if (typeof range === 'number' && typeof module.setRange === 'function') module.setRange(range);
