(function() {
    ...
    // ====== 3) WPN_RPG.OnFireBtnPressed — RPG/AT4 单独处理 ======
    // RPG 不走 GunShoot（WPN_RPG 继承 Weapon，不是 WPN_Gun）
    // 阻塞点：fireState 状态机（RPG+0xF8）+ fireAnimRate 动画长
    // AT4 也是 WPN_RPG 类，一个 Hook 同时覆盖
    ...
    // ====== 5) Recoil.GetCurrentPerturb — 强制 0 扩散 ======
