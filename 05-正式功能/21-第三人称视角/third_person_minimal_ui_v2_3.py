...
SCRIPT_NAME = "third_person_minimal_demo_v2_3.js"
...
class MinimalThirdPersonUI(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.emit_log("UI 已启动。v2.3 的开启、关闭和参数应用全部由游戏主线程执行。")
    ...
    def build_status_tab(self, tab: Any) -> None:
        ...
        fields = [
            ...
            ("FreeLook处理后Y", "lastYAxisAfterUpdate"),
        ]
    ...
    def apply_status(self, status: Any) -> None:
        ...
        values = {
            ...
            "lastYAxisAfterUpdate": (
                f"{float(stats.get('lastYAxisAfterUpdate', 0.5)):.3f}"
            ),
        }
