...
SCRIPT_NAME = "third_person_combat_v3_2_camera_stable.js"
...
class ThirdPersonCombatUI(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.emit_log("UI 已启动。v3.2 已启用换肩防抖、轻量换肩和纵向镜头平滑。")
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        # v3.1 的旧配置默认开启 V 键换肩。
        # 升级到 v3.2 时强制关闭一次，防止继续触发镜头反复重建。
        if str(loaded.get("configVersion", "")) != "3.2":
            config["dynamicShoulder"] = False
        config["configVersion"] = "3.2"
    ...
    def apply_status(self, status: Any) -> None:
        ...
        values = {
            ...
            "shoulderLightweightApplies": stats.get(
