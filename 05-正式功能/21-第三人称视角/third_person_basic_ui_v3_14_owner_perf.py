...
APP_VERSION = "3.14-perf"
PROCESS_NAMES = ("unitycrossfire.exe", "unitycrossfire")
SCRIPT_NAME = "third_person_basic_v3_14_owner_perf.js"

BASE_DIR = Path(__file__).resolve().parent
SCRIPT_PATH = BASE_DIR / SCRIPT_NAME
CONFIG_PATH = BASE_DIR / "third_person_basic_v3_14_owner_perf_config.json"
...
class MinimalTPSUI(ctk.CTk):
    ...
    def build_status_tab(self, tab: Any) -> None:
        ...
        fields = [
            ...
            ("枪口 owner 异常", "muzzleOwnerMismatches"),
            ("安全恢复跳过", "safeRestoreSkips"),
            ("旧指针跳过", "stalePointerSkips"),
            ("相机健康检查", "cameraCacheHealthChecks"),
    ...
    def apply_status(self, status: dict[str, Any]) -> None:
        ...
        values = {
            ...
            "muzzleOwnerMismatches": stats.get(
                "muzzleOwnerMismatches",
                0,
            ),
            "safeRestoreSkips": stats.get(
                "safeRestoreSkips",
                0,
            ),
            "stalePointerSkips": stats.get(
                "stalePointerSkips",
                0,
            ),
            "cameraCacheHealthChecks": stats.get(
        ...
        summary = {
            ...
            "stats": {
                ...
                "muzzleOwnerChecks": stats.get("muzzleOwnerChecks"),
                "muzzleOwnerMismatches": stats.get("muzzleOwnerMismatches"),
