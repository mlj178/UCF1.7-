...
SCRIPT_NAME = "third_person_minimal_demo_v2_2.js"
...
class MinimalThirdPersonUI(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.emit_log("UI 已启动。v2.2 支持晚连接；进入对局后可自动开启，并记录 PitchTelemetry。")
