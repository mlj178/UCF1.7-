...
class FixedPointTeleportApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self.save_button.grid(row=0, column=0, padx=8, pady=12, sticky="ew")
    ...
    def _render_status(self, status):
        ...
        if last_error:
            ...
            self.detail_label.configure(text="已开启，可保存当前位置或瞬移", text_color=GREEN)
        elif enabled:
