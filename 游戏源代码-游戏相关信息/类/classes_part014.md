...
- `Bounds bounds`（Bounds bounds）(偏移: 0x20)
...
- `int m_Collider`（int m_碰撞器）(偏移: 0x28)
...
- `int m_Collider`（int m_碰撞器）(偏移: 0x20)
...
- `float distance`（float distance）(偏移: 0x8)
- `float index`（float index）(偏移: 0xC)
- `int depth`（int depth）(偏移: 0x10)
...
- `Vector3 rotation`（三维向量 rotation）(偏移: 0x140)
...
- `Bounds bounds`（Bounds bounds）(偏移: 0x18)
...
- `Bounds bounds`（Bounds bounds）(偏移: 0x10)
- `bool dynamic`（bool dynamic）(偏移: 0x28)
- `int area`（int area）(偏移: 0x2C)
...
- `float length`（float length）(偏移: 0x98)
- `bool initiated`（bool initiated）(偏移: 0x9C)
- `float blendWeight`（float blendWeight）(偏移: 0xA0)
- `float w`（float w）(偏移: 0xA4)
...
- `bool snapping`（bool snapping）(偏移: 0x0)
...
- `float width`（float width）(偏移: 0x48)
- `float height`（float height）(偏移: 0x4C)
- `FalloffType falloff`（Falloff类型 falloff）(偏移: 0x50)
...
- `Hashtable _caps`（Hashtable _caps）(偏移: 0x14)
...
- `Hashtable _caps`（Hashtable _caps）(偏移: 0x38)
...
- `Hashtable _caps`（Hashtable _caps）(偏移: 0xC)
...
- `Hashtable _caps`（Hashtable _caps）(偏移: 0x2C)
...
- `ProfilingSampler m_ProfilingSampler`（ProfilingSampler m_ProfilingSampler）(偏移: 0x34)
...
- `bool m_Disposed`（bool m_Disposed）(偏移: 0xC)
...
- `FilteringSettings m_FilteringSettings`（FilteringSettings m_FilteringSettings）(偏移: 0x58)
...
- `ProfilingSampler m_ProfilingSampler`（ProfilingSampler m_ProfilingSampler）(偏移: 0x78)
...
- `string m_Name`（string m_名称）(偏移: 0x8)
