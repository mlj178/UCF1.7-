...
- `GameObject effect`（游戏对象 effect）(偏移: 0xC)
...
- `float m_Value`（float m_值）(偏移: 0x0)
...
## BaseNumberConverter（基础NumberConverter）
...
- `int assemId`（int assemId）(偏移: 0x20)
- `BinaryHeaderEnum binaryHeaderEnum`（Binary标题Enum binary标题Enum）(偏移: 0x24)
...
- `int assemId`（int assemId）(偏移: 0x8)
...
- `string assemblyString`（string assembly字符串）(偏移: 0x8)
...
- `StreamingContext m_context`（StreamingContext m_context）(偏移: 0xC)
...
- `string typeName`（string type名称）(偏移: 0xC)
- `object[] args`（object[] args）(偏移: 0x10)
...
- `BinaryHeaderEnum binaryHeaderEnum`（Binary标题Enum binary标题Enum）(偏移: 0x8)
- `int objectId`（int objectId）(偏移: 0xC)
- `string name`（string name）(偏移: 0x10)
- `int numMembers`（int numMembers）(偏移: 0x14)
- `string[] memberNames`（string[] memberNames）(偏移: 0x18)
- `int assemId`（int assemId）(偏移: 0x1C)
...
- `int assemId`（int assemId）(偏移: 0x28)
...
- `byte[] _buffer`（byte[] _buffer）(偏移: 0xC)
...
- `Transform head`（变换 head）(偏移: 0x40)
...
- `string get_humanizedData()`
  （string get_humanized数据（））
- `bool get_Item(uint index)`
  （bool get_项目（uint index））
- `void set_Item(uint index, bool value)`
  （void set_项目（uint index, bool value））
...
- `IBitArray BitAnd(IBitArray other)`
  （IBit数组 BitAnd（IBit数组 other））
- `IBitArray BitOr(IBitArray other)`
  （IBit数组 BitOr（IBit数组 other））
- `IBitArray BitNot()`
  （IBit数组 BitNot（））
...
- `int priority`（int priority）(偏移: 0x20)
...
- `object[] _args`（object[] _args）(偏移: 0x8)
...
- `string _uri`（string _uri）(偏移: 0x1C)
...
- `void OnAnimationEnd(string animName, string animTag)`
  （void On动画结束（string animName, string animTag））
...
- `Hashtable _caps`（Hashtable _caps）(偏移: 0x10)
...
- `bool m_isReadOnly`（bool m_isReadOnly）(偏移: 0xC)
