...
- `Encoding encoding`（Encoding encoding）(偏移: 0x10)
...
- `Encoding encoding`（Encoding encoding）(偏移: 0x18)
...
## SymmetricTransform（Symmetric变换）
...
- `bool m_disposed`（bool m_disposed）(偏移: 0x2C)
...
- `bool inited`（bool inited）(偏移: 0x60)
...
- `Seeker seeker`（Seeker seeker）(偏移: 0x18)
...
- `float interval`（float interval）(偏移: 0x18)
...
- `string name`（string name）(偏移: 0x4C)
...
- `float interval`（float interval）(偏移: 0x2C)
